...
<div class="container">
    ...
    <div >
        <p>ini halaman visi misi buat admin.</p>
    </div>
...
<!--      <li><a href="#">Agenda</a></li>
 ...
 <div class="form-group">
      <label for="textArea" class="col-lg-2 control-label">Visi</label>
      <div class="col-lg-5">
        <textarea class="form-control" rows="3" id="textArea"></textarea>
        <span class="help-block">Isikan visi sekolah pada kolom di atas.</span>
      </div>
       <label for="textArea" class="col-lg-2 control-label">Misi</label>
      <div class="col-lg-5">
        <textarea class="form-control" rows="3" id="textArea"></textarea>
        <span class="help-block">Isikan misi sekolah pada kolom di atas</span>
      </div>
    </div>
 <div class="form-group">
