...
<div class="container">
    ...
    <div >
        <p>ini halaman jadwal kegiatan</p>
    </div>
...
<!--      <li><a href="#">Agenda</a></li>
      ...
      <li><a href="#">PPDB</a></li> -->
         ...
         <li><a href="<?php echo base_url();?>home/agenda">Peraturan</a></li>
      <li><a href="<?php echo base_url();?>home/galeri">Persyaratan</a></li>
      
      <li><a href="<?php echo base_url();?>home/ppdb">Tata Cara Pendaftaran</a></li>
      <li><a href="<?php echo base_url();?>home/ppdb">Jadwal Kegiatan</a></li>
      <li><a href="<?php echo base_url();?>home/ppdb">Hasil Seleksi</a></li>
