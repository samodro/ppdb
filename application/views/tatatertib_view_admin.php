...
<div class="container">
    ...
    <div >
        <p>ini halaman tatatertib buat admin.</p>
    </div>
...
<!--      <li><a href="#">Agenda</a></li>
 ...
 <div class="form-group">
      <label for="textArea" class="col-lg-2 control-label">Tata Tertib</label>
      <div class="col-lg-10">
        <textarea class="form-control" rows="3" id="textArea"></textarea>
        <span class="help-block">Isikan tata tertib sekolah pada kolom di atas.</span>
      </div>
    </div>
 <div class="form-group">
